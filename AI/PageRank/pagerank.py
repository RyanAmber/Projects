...
#python AI/PageRank/pagerank.py AI/PageRank/corpus0 RUN THIS
def main():
    if len(sys.argv) != 2:
...
def transition_model(corpus, page, damping_factor):
    ...
    distribution={}
    for i in pages:
        distribution[i]=((1-damping_factor)/pagenum)
    for i in corpus.get(page):
        distribution[i]=distribution.get(i)+(damping_factor/len(corpus.get(page)))
    return distribution
